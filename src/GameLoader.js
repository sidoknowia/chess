				...
				<div className="row" id="place_center">
					<div className="span8">
						<div className="chess-board">
							<div className="block white-block" id="a8"><span className="piece">&#9820;</span></div>
							...
							<div className="block black-block" id="a7"><span className="piece">&#9823;</span></div>
							...
							<div className="block white-block" id="a4"></div>
							...
							<div className="block black-block" id="a3"></div>
							...
							<div className="block white-block" id="a2"><span className="piece">&#9817;</span></div>
							...
							<div className="block black-block" id="a1"><span className="piece">&#9814;</span></div>
